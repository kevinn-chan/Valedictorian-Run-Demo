    ...
    >
      ...
      >
        ...
        <button
          type="submit"
          disabled={busy}
          className="h-11 rounded-xl bg-primary px-4 text-sm font-medium text-primary-foreground transition hover:-translate-y-0.5 hover:bg-primary/90 active:scale-95 disabled:opacity-60"
        >
          Ask
        </button>
      </form>
