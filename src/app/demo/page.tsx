    ...
    <div className="min-h-screen bg-background text-foreground">
      <header className="mx-auto flex w-full max-w-5xl items-center justify-between px-6 py-5">
        ...
        <div className="flex items-center gap-2">
          ...
          <Link
            href="/"
            className="inline-flex min-h-11 items-center rounded-full border border-border bg-card px-4 text-sm font-medium text-primary transition hover:-translate-y-0.5 hover:border-primary/50 active:scale-95"
          >
            What is this?
          </Link>
        </div>
